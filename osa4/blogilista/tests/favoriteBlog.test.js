...
describe('favoriteBlog', () => {
  ...
  test('multiple blogs with different number of likes returns blog with most likes', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
  ...
  test('multiple blogs with same number of likes returns the first of the blogs with most likes', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
