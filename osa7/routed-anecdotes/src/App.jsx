...
const Menu = ({ anecdotes, anecdoteById, addNew, notify, notification }) => {
  const padding = {
    paddingRight: 5
  }
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} anecdoteById={anecdoteById} addNew={addNew} notify={notify} notification={notification} />
      <Footer />
    </div>
  )
}
